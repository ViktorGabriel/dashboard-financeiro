...
export function SummaryCards({ refreshKey }: SummaryCardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      {/* Card de Receitas */}
      <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-200/80 hover:border-emerald-500/30 hover:shadow-md hover:shadow-emerald-500/5 transition-all duration-300 flex flex-col justify-between group">
        <div>
          <div className="flex items-center justify-between mb-4">
            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
              Entradas / Receitas
            </span>
            <div className="p-2 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-600 group-hover:scale-105 transition-transform">
              <TrendingUp size={18} />
            </div>
          </div>
        ...
        <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
          ...
          <span className="font-semibold text-emerald-600 text-xs">+{formatCurrency(incomes)}</span>
        </div>
      </div>

      {/* Card de Despesas */}
      <div className="rounded-2xl bg-white p-6 shadow-sm border border-slate-200/80 hover:border-rose-500/30 hover:shadow-md hover:shadow-rose-500/5 transition-all duration-300 flex flex-col justify-between group">
        <div>
          <div className="flex items-center justify-between mb-4">
            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
              Saídas / Despesas
            </span>
            <div className="p-2 rounded-xl bg-rose-50 border border-rose-100 text-rose-600 group-hover:scale-105 transition-transform">
        ...
        <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
          ...
          <span className="font-semibold text-rose-600 text-xs">-{formatCurrency(expenses)}</span>
        </div>
      </div>
    </div>
  );
